...
for($count = 15; $count > 0; $count--){
  ...
  $arr = array(date('d', strtotime($day."-$count day")).'일',(int)$temp_row['AVG(CO2_D)']);
  array_push($data,$arr);
}
...
$options = array(
  ...
  'title'  => '평균 이산화탄소 그래프 ('.(date('m').'월)'),  // 그래프 제목

  'titleTextStyle' => array('fontSize' => 16), // 제목 스타일

  'vAxes'  => array(0 => array('title'    => '평균 이산화탄소（PPM）',  // 세로축 왼쪽
