...
<div class="organization_area">
	<div class="organization">
		...
		<div class="team_area">
			...
			<dl class="team2">
				<dt><a href="#n">재활사업부</a></dt>
				<dd><a href="#n">
					<span>상담가족<br>지원팀</span>
					<p>- 상담지원<br>- 가족지원<br>- 교육재활<br>- 아동발달<br>- 방과후교육(초등)</p>
				</a></dd>
				<dd><a href="#n">
				...
				<dd><a href="#n">
					...
					<p>- 사회재활<br>- 직업재활<br>- 방과후교육(중고등)<br>- 정보화교육</p>
				</a></dd>
				<dd><a href="#n">
					<span>지역<br>복지팀</span>
					<p>- 재가복지<br>- 사례관리<br>- 문화여가<br>- 시각지원<br>- 활동보조</p>
				</a></dd>
			</dl>
			<dl class="team3">
	...
	<div class="organization_detail_page"><!--// 총무팀 -->
		...
		<div class="organization_detail">
			<ul>
				...
				<li>
					<p class="picture"><img src="<?=$g4[path]?>/images/sub1/picture_img140.jpg" alt="운영지원팀 서은혜씨 사진입니다." /></p>
					<div class="detail">
						<p class="name">서은혜</p>
						<p>직위 : 대리</p>
						<p>업무 : 인사, 총무관리</p>
						<p>메일 : petalsgirl16@naver.com</p>
					</div>
				</li>
				<li>
	...
	<div class="organization_detail_page"><!--// 기능향상지원팀 -->
		...
		<div class="organization_detail">
			<ul>
				...
				<li>
					<!-- <p class="picture"><img src="<?=$g4[path]?>/images/sub1/picture_img51.jpg" alt="기능향상지원팀 오연진씨 사진입니다." /></p>
					<div class="detail">
						<p class="name">오연진</p>
						<p>직위 : 미술치료사</p>
						<p>업무 : 미술치료</p>
						<p>메일 : oh9410629@naver.com</p>
					</div> -->
				</li>
				<li>
