	...
	<div class="history">
		<ul>
			<li>
				...
				<span class="text">필리핀, 네팔 보건위생용품 지원</span>
				<span class="icon"><img src="<?=$g4[path]?>/images/sub1/history_icon.gif" alt="" /></span>
			</li>
			<li>
				<span class="month">03</span>
				<span class="text">안양시 남북교류협력위원회 민간지원 단체 선정</span>
			</li>
			<li>
				<span class="month">05</span>
				<span class="text">중국 단동지역 희망책가방 지원</span>
			</li>
			<li>
				<span class="month">06</span>
				<span class="text">네팔, 스와질랜드 염소 및 위생용품 지원</span>
			</li>
			<li>
				<span class="month">10</span>
				<span class="text">태국, 미얀마 우물파기 및 위생용품 지원</span>
			</li>
			<li>
				<span class="month">11</span>
				<span class="text">인도네시아 우물파기 지원</span>
			</li>
		</ul>
		<ul>
			<li>
				...
				<span class="text">중국 단동지역 북한 아동, 노동자 돕기 및 의료지원 / 스와질랜드 에쿠토코제니학교 염소지원</span>
				<span class="icon"><img src="<?=$g4[path]?>/images/sub1/history_icon.gif" alt="" /></span>
			</li>
			<li>
				<span class="month">03</span>
				<span class="text">중국 단동지역 북한 노동자 가정 아동돕기 사업장 개소</span>
			</li>
			<li>
				<span class="month">05</span>
				<span class="text">수원지역아동센터연합회 어린이날 행사 개최</span>
			</li>
			<li>
				<span class="month">08</span>
				<span class="text">탄자니아 싸싸질라학교 염소지원</span>
			</li>
			<li>
				<span class="month">11</span>
				<span class="text">안양시 기부축제 개최</span>
			</li>
		</ul>
		<ul>
			<li>
