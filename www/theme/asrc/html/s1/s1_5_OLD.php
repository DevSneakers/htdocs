...
<div class="organization_area">
	<div class="organization">
		...
		<div class="executives executives4"><a href="#n">자립생활지원부<br>사무국장</a></div>
		<div class="team_area">
			<dl class="team1">
...
-->
			...
			<dl class="team4">
				<dt class="pad_top66"><!-- <a href="#n">자립생활지원부</a> --></dt>
				<dd class="first"><a href="#n">
...
<!-- 					<tr>
	...
	<div class="organization_detail_page"><!--// 자립생활지원부 사무국장 -->
...
<div class="organization_detail_page"><!--// 평생교육지원팀 -->
	...
	<div class="organization_detail_page"><!--// 활동보조지원센터 -->
