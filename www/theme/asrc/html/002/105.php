      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;">
                  <font face="바탕"><span style="font-size: 36px;">평생교육지원사업</span></font>
               </p>
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">&nbsp;</span>
               </p>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;">
                  <font face="바탕"><span style="font-size: 36px;">장애인의 권리존중을 기반으로 생애전환에 따른 적절한 서비스를 제공하여 지역사회 안에서 행복한 삶을 누릴 수 있도록 지원합니다.</span></font>
               </p>
               </td>
            </tr>
         </tbody>
   ...
   <table cellpadding="1" cellspacing="0" style="border-color: #ffffff; border-style: solid; border-width: 1px; border-collapse: collapse; width: 800px;">
      <tbody>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="">
                  <span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><span style="font-size: 28px; font-family: 바탕;">평생교육·훈련/고용개발</span>
               </p>
               </td>
            </tr>
         </tbody>
...
<p>
   <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616160848_c7d1b9700719bcbc76e0ff08e75414f4_w2n2.jpg" alt="20210616_160832.jpg" style="width: 800px; height: 653px;" />
</p>
