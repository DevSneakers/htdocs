      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;"><font face="바탕"><span style="font-size: 36px;">치료바우처사업</span></font></p>
               <p style="text-align: center;"><span style="font-size: 36px; font-family: 바탕;">&nbsp;</span></p>
               </td>
            </tr>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;"><font face="바탕"><span style="font-size: 36px;">바우처 제공기관으로 각종 재활치료서비스 및 사회적응 프로그램을 제공합니다.</span></font></p>
               </td>
            </tr>
         </tbody>
      </table>
...
<p>
   <table cellpadding="1" cellspacing="0" style="border-color: #ffffff; border-style: solid; border-width: 1px; border-collapse: collapse; width: 800px;">
      <tbody>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;"><span style="font-family: 바탕;"><br /></span><br /></td>
            </tr>
         <tr>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style=""><span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><font face="바탕"><span style="font-size: 28px;">사회서비스센터사업</span><span style="font-size: 28px;">(아동발달)</span></font></p>
               <p>
                  <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616164849_c7d1b9700719bcbc76e0ff08e75414f4_zv16.jpg" alt="20210616_164834.jpg" style="width: 800px; height: 506px;" />
               </p>
               </td>
            </tr>
         </tbody>
