      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;">
                  <font face="바탕"><span style="font-size: 36px;">생활체육사업</span></font>
               </p>
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">&nbsp;</span>
               </p>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;">
                  <font face="바탕"><span style="font-size: 36px;">재활(운동)을 통하여 장애인과 비장애인의 건강한 삶을 지원합니다.</span></font>
               </p>
               </td>
            </tr>
         </tbody>
   ...
   <table cellpadding="1" cellspacing="0" style="border-color: #ffffff; border-style: solid; border-width: 1px; border-collapse: collapse; width: 800px;">
      <tbody>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="">
                  <span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><span style="font-size: 28px; font-family: 바탕;">생활체육사업</span>
               </p>
               </td>
            </tr>
         </tbody>
...
<p>
   <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616161412_c7d1b9700719bcbc76e0ff08e75414f4_fcfh.jpg" alt="20210616_161400.jpg" style="width: 800px; height: 757px;" />
</p>
