      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">상담가족</span>
               </p>
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">&nbsp;</span>
               </p>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;">
                  <span style="font-size: 36px; font-family: 바탕;">장애인의 특성에 맞는 개별화 된 서비스 개입 계획을 수립하고, 복지정보 안내와 서비스 연계를 통해 건강한 삶을 지원합니다. 또한 장애자녀를 둔 보호자 및 가족의 역량을 강화하여 가족의 순기능 향상을 돕습니다.</span>
               </p>
               </td>
            </tr>
         </tbody>
   ...
   <table cellpadding="1" cellspacing="0" style="border-color: #ffffff; border-style: solid; border-width: 1px; border-collapse: collapse; width: 800px;">
      <tbody>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="">
                  <span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><font face="바탕"><span style="font-size: 28px;">상담가족지원</span></font>
               </p>
               <p>
                  <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616151511_c7d1b9700719bcbc76e0ff08e75414f4_gx3w.jpg" alt="20210616_151455.jpg" style="width: 284px; height: 937px;" />
               </p>
               </td>
            </tr>
         </tbody>
