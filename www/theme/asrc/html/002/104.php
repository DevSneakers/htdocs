      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;">
                  <font face="바탕"><span style="font-size: 36px;">기능향상지원</span></font>
               </p>
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">&nbsp;</span>
               </p>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;">
                  <font face="바탕"><span style="font-size: 36px;">이용자의 현 상황을 고려하여 일상생활 능력의 향상 및 사회적응을 위한 치료와 교육서비스를 제공합니다.</span></font>
               </p>
               </td>
            </tr>
         </tbody>
   ...
   <table cellpadding="1" cellspacing="0" style="border-color: #ffffff; border-style: solid; border-width: 1px; border-collapse: collapse; width: 800px;">
      <tbody>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="">
                  <span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><font face="바탕"><span style="font-size: 28px;">기능향상지원사업</span></font>
               </p>
               <p>
                  <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616152233_c7d1b9700719bcbc76e0ff08e75414f4_cawj.jpg" alt="20210616_152219.jpg" style="width: 623px; height: 936px;" />
               </p>
               <p style="">
                  <font face="바탕"><span style="font-size: 28px;">&nbsp;</span></font>
               </p>
               <p style="">
                  <font face="바탕"></font><span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><font face="바탕"><span style="font-size: 28px;">교육재활</span></font>
               </p>
               <p>
                  <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616152326_c7d1b9700719bcbc76e0ff08e75414f4_mkgx.jpg" alt="20210616_152304.jpg" style="width: 800px; height: 368px;" />
               </p>
               </td>
            </tr>
         </tbody>
