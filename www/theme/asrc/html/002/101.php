      ...
      <tbody>
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               ...
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">운영 지원</span>
               </p>
               <p style="text-align: center;">
                  <span style="font-size: 36px; font-family: 바탕;">&nbsp;</span>
               </p>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="line-height: 1.5;">
                  <span style="font-family: 바탕; font-size: 36px;">복지관 운영전반을 지원하며,&nbsp;</span>
               </p>
               <p style="line-height: 1.5;">
                  <span style="font-family: 바탕; font-size: 36px;">이용장애인의 편의증진을 도모하고 있습니다.</span>
               </p>
               </td>
            </tr>
         <tr>
         ...
         <tr>
            <td style="border-style: solid; border-width: 1px; border-color: #ffffff;">
               <p style="">
                  <span style="font-size: 24px;"><img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210609133120_1ea786a0e48ecec10e2c234ad2c574fa_tulf.jpg" alt="n5gk.jpg" style="width: 30px; height: 32px;" />&nbsp;</span><font face="바탕"><span style="font-size: 28px;">운영지원사업</span></font>
               </p>
               <p style="">
                  <span style="font-size: 28px; font-family: 바탕;">&nbsp;</span>
               </p>
               <p>
                  <img src="http://hahaza.cafe24.com/yjh/data/editor/2106/20210616144633_c7d1b9700719bcbc76e0ff08e75414f4_0yz8.jpg" alt="20210616_144610.jpg" style="width: 606px; height: 933px;" />
               </p>
               <p style="">&nbsp;</p>
               <p style="">
                  <br />
