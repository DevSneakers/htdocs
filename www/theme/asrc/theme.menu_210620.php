...
$first_menu["이용안내"] = G5_THEME_URL."/html/001/01.php";
$first_menu_target["이용안내"] = "_self";
$first_menu_so_title["이용안내"] = "";	//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$first_menu["참여공간"] = G5_THEME_URL."/html/001/01.php";
$first_menu_target["참여공간"] = "_self";
$first_menu_so_title["참여공간"] = "";	//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$first_menu["알립니다"] = G5_BBS_URL."/board.php?bo_table=online";
$first_menu_target["알립니다"] = "_self";
$first_menu_so_title["알립니다"] = "질문주시면 빠른 시간내에 피드백드리겠습니다.";

$first_menu["복지관 소개"] = G5_THEME_URL."/html/company/01.php";
$first_menu_target["복지관 소개"] = "_self";
$first_menu_so_title["복지관 소개"] = "";	//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.
...
/***			이용안내			***********************************************************************/
$second_menu["이용안내"]["이용절차"] = G5_THEME_URL."/html/001/001.php";
$second_menu_target["이용안내"]["이용절차"] = "_self";
$second_menu_so_title["이용안내"]["이용절차"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["이용안내"]["사업별 안내"] = G5_THEME_URL."/html/002/101.php";
$second_menu_target["이용안내"]["사업별 안내"] = "_self";
$second_menu_so_title["이용안내"]["사업별 안내"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["이용안내"]["대기자 현황"] = G5_THEME_URL."/html/wait/wait_pass.php";
$second_menu_target["이용안내"]["대기자 현황"] = "_self";
$second_menu_so_title["이용안내"]["대기자 현황"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.
...
/***			복지관 소개			***********************************************************************/
$second_menu["복지관 소개"]["인사말"] = G5_THEME_URL."/html/005/016.php";
$second_menu_target["복지관 소개"]["인사말"] = "_self";
$second_menu_so_title["복지관 소개"]["인사말"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["복지관 소개"]["기관소개"] = G5_THEME_URL."/html/005/017.php";
$second_menu_target["복지관 소개"]["기관소개"] = "_self";
$second_menu_so_title["복지관 소개"]["기관소개"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["복지관 소개"]["법인소개"] = G5_THEME_URL."/html/005/022.php";
$second_menu_target["복지관 소개"]["법인소개"] = "_self";
$second_menu_so_title["복지관 소개"]["법인소개"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["복지관 소개"]["조직현황"] = G5_THEME_URL."/html/005/023.php";
$second_menu_target["복지관 소개"]["조직현황"] = "_self";
$second_menu_so_title["복지관 소개"]["조직현황"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["복지관 소개"]["권익옹호"] = G5_THEME_URL."/html/005/024.php";
$second_menu_target["복지관 소개"]["권익옹호"] = "_self";
$second_menu_so_title["복지관 소개"]["권익옹호"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.

$second_menu["복지관 소개"]["시설안내"] = G5_THEME_URL."/html/001/006.php";
$second_menu_target["복지관 소개"]["시설안내"] = "_self";
$second_menu_so_title["복지관 소개"]["시설안내"] = "";//커스텀 웹페이지는 해당 페이지내에 직접 입력합니다.
