...
<section id="bo_w">
	...
	<div>항목명과 내용은 " : " 콜론 으로 구분합니다. 내용에 구분자(" : " 콜론)를 넣으면 안됩니다.</div>
	 <?php for($i=1; $i<=7; $i++){ //  wr_10 은 브랜드로 씀 8,9는 안씀?>
	  ...
	  <div class="write_div">      
        <label for="wr_<?php echo $i?>" class="sound_only">추가항목설정</label>
        <input type="text" name="wr_<?php echo $i?>" value="<?php echo ${"wr_".$i}?>" id="wr_<?php echo $i?>" class="frm_input full_input" size="50" placeholder="항목명:내용">
    </div>
	 <?php }?>
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="제목(상품명)">
