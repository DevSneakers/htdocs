...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class=""><?php echo subject_sort_link('wr_1', $qstr2, 1) ?>프로그램명  </a></th>
            <th scope="col" class="lview"><?php echo subject_sort_link('wr_2', $qstr2, 1) ?>대기순번  </a></th>
            <th scope="col" class="lview"><?php echo subject_sort_link('wr_3', $qstr2, 1) ?>접수번호  </a></th>
            <th scope="col" class="lview"><?php echo subject_sort_link('wr_4', $qstr2, 1) ?>접수일  </a></th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_subject td_center " style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                <?php
            ...
            <td class="td_center lview"><?php echo $list[$i]['wr_2'] ?></td>
			<td class="td_center lview"><?php echo $list[$i]['wr_3'] ?></td>
			<td class="td_center lview"><?php echo $list[$i]['wr_4'] ?></td>
        </tr>
        <?php } ?>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
			...
			<?php if ($write_href) { ?><li><a href="#none" onclick='window.open("<?php echo G5_THEME_URL?>/bexcel.php", "win_excel", "width=600,height=600,left=10,top=10");' class="btn_b011 btn" title="글쓰기"><i class="fas fa-pencil-alt"></i><span class="">엑셀업로드</span></a></li><?php } ?>
        </ul>	
        <?php } ?>
    </div>
    <?php } ?>   
    ...
    <div class="bo_sch_wrap">
        <fieldset class="bo_sch">
            ...
            <select name="sfl" id="sfl">
                <option value="wr_subject" <?php echo get_selected($sfl, 'wr_subject', true)?>>프로그램명</option>
                <option value="wr_name" <?php echo get_selected($sfl, 'wr_name', true)?>>이름</option>
                <option value="wr_1" <?php echo get_selected($sfl, 'wr_1', true)?>>생년월일</option>
            </select>
