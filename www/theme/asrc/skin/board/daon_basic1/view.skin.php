    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
				<?php if ($write_href) { ?><li><a href="<?php echo $list_href ?>" class="btn_b011 btn" title="목록"><i class="fa fa-list" aria-hidden="true"></i><span class="">목록</span></a></li><?php } ?>
...
;				
	...
	<br>
	<center><a href="/" class="btn_b011 btn" title="목록"><i class="fa fa-angle-left"></i><span class="">확인</span></a></center>
