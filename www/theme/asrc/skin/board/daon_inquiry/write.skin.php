...
<section id="bo_w">
	...
	<?php if ($is_admin){ ?>
    <div class="bo_w_select write_div">
        <label for="wr_2"  class="sound_only">상태<strong>필수</strong></label>
        <select name="wr_2" id="wr_2" required>
            <option value="">상태를 선택하세요</option>
            <option value="접수" <?php if($wr_2 == "접수") echo "selected";?>>접수</option>
            <option value="완료" <?php if($wr_2 == "완료") echo "selected";?>>완료</option>
        </select> 
    </div> 상태처리는 관리자만 노출됩니다.
	 <?php }else{ ?>
	<input type="hidden" name="wr_2" value="<?php if($wr_2) echo $wr_2; else echo "접수"; ?>">
	 <?php } ?>
    ...
    <div class="bo_w_info write_div">
	    ...
	    <?php } ?>
			...
			<input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input " size="30" placeholder="연락처">
	</div>
