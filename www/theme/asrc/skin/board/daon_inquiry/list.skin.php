...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
			...
			<td class="td_status"><span class=" <?php echo ($list[$i]['wr_2']=="완료" ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['wr_2']=="완료" ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 접수'); ?></span></td>
        </tr>
        <?php } ?>
