...
<fieldset id="faq_sch">
    ...
    <div class="faq_sch_div"><input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input" size="15" maxlength="15"></div>
...
<div class="select_bo_cate mview">
	<a class="sel" rel="선택"><?php if($fm['fm_subject']) echo $fm['fm_subject']; else echo "카테고리 선택"; ?></a>
