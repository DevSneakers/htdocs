...
<div id="sch_result">
    ...
    if ($stx) {
        if ($board_count) {
     ?>
	  <ul id="sch_res_board" class="mnone">
        <li><a href="?<?php echo $search_query ?>&amp;gr_id=<?php echo $gr_id ?>" <?php echo $sch_all ?>>전체게시판</a></li>
        <?php echo $str_board_list; ?>
    </ul>

	<div class="select_bo_cate mview">
		<a class="sel" rel="선택"><?php if($fm['fm_subject']) echo $fm['fm_subject']; else echo "전체"; ?></a>
		<ul style="display:none;">
			 <li><a href="#none" <?php echo $category_option;?> >전체</a></li>
			  <?php echo str_replace("stron","span",$str_board_list); ?>
		</ul>
	</div>
    <?php
        } else {
